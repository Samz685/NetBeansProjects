...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboCurso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DAM", "DAW", "ASIR" }));
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        comboCurso.getModel().setSelectedItem( (String) modeloTabla.getValueAt(pos_actual, 3) );
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        if( formularioVacio() ) {
            JOptionPane.showConfirmDialog(null, "Debes completar todos los campos", "Campos vacios", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        JOptionPane.showConfirmDialog(null, "¿Desea borrar?",
                "Borar Alumno",
